...
module.exports = (sequelize, DataTypes) => {
  class Items extends Model {
    static associate(models) {
      Items.belongsTo(models.Items_info, {
        foreignKey: "idItems",
        targetKey: "itemsId",
        as: "infoItemsData",
      });
      Items.belongsTo(models.Type, {
        foreignKey: "type",
        targetKey: "code",
        as: "typeData",
      });
      ...
      Items.belongsTo(models.Store, {
        foreignKey: "manageId",
        targetKey: "manageId",
        as: "storeData",
      });
      Items.belongsTo(models.Discount, {
        foreignKey: "discounts",
        targetKey: "code",
        as: "discountData",
      });
      Items.belongsTo(models.Items_color_image, {
        foreignKey: "idItems",
        targetKey: "itemId",
        as: "dataImgItems",
      });
